...
bool TestCases::testPalindromeCase1()
{
	...
	return isPalindrome(value, 0, static_cast<int>(value.length() - 1));
}
...
bool TestCases::testPalindromeCase2()
{
	...
	for (auto test : possiblePallindromes)
	{
		...
		bool isOne = isPalindrome(collapsed, 0, static_cast<int>(collapsed.length() - 1));
...
bool TestCases::testWordSymmetricCase1()
{
	...
	bool result = isWordSymmetric(words, 0, static_cast<int>(words.size() - 1));
...
bool TestCases::testWordSymmetricCase2()
{
	...
	for (auto test : possibleSymmetric)
	{
		...
		bool isOne = isWordSymmetric(words, 0, static_cast<int>(words.size() - 1));
...
bool TestCases::testSortCase1()
{
	...
	quickSort(input, 0, static_cast<int>(input.size() - 1));
